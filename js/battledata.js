...
function encodeFusionID(first,second){
return toID(first+'/'+second);
}

function decodeFusionID(id){
var _id$split=id.split('/',2),a=_id$split[0],b=_id$split[1];
return[toID(a),toID(b)];
}

function calculateFusionStats(headStats,bodyStats)
{
return{
hp:Math.round((headStats.hp*2+bodyStats.hp)/3),
atk:Math.round((headStats.atk+bodyStats.atk*2)/3),
def:Math.round((headStats.def+bodyStats.def*2)/3),
spa:Math.round((headStats.spa*2+bodyStats.spa)/3),
spd:Math.round((headStats.spd*2+bodyStats.spd)/3),
spe:Math.round((headStats.spe+bodyStats.spe*2)/3)
};
}
...
var _decodeFusionID=decodeFusionID(nameOrSpecies),first=_decodeFusionID[0],second=_decodeFusionID[1];
if(second)
{

var d=Object.assign({},_this.species.get(first));
var d2=Object.assign({},_this.species.get(second));

var fusedId=encodeFusionID(d.name,d2.name);
d.name=d.name+"/"+d2.name;
d.baseStats=calculateFusionStats(d.baseStats,d2.baseStats);
d.baseSpecies=d.baseSpecies+"/"+d2.baseSpecies;


d.abilities=[].concat(d.abilities);
for(var i in d2.abilities){
d.abilities.push(d2.abilities[i]);
}

var firstType=window.BattleFusionData[first]?window.BattleFusionData[first].type:null;
var secondType=window.BattleFusionData[second]?window.BattleFusionData[second].type:null;


d.types=[
firstType?firstType:d.types[0],
secondType?secondType:d2.types[d2.types.length-1]];


if(d.types[0]===d.types[1]){
d.types.pop();
}

d.spriteid=toID(d.baseSpecies);
if(window.BattleFusionData[first]&&!window.BattleFusionData[first].customsprites[second]){


}

d.fusionName=d.name;
if(window.BattleFusionData[first]&&window.BattleFusionData[second])
{
var firstPart=window.BattleFusionData[first].nameparts[0];
var secondPart=window.BattleFusionData[second].nameparts[1];

if(firstPart.slice(-1)===secondPart.slice(0,1))secondPart=secondPart.slice(1);

if(firstPart.slice(-1)===' '){
secondPart=secondPart.slice(0,1).toUpperCase()+secondPart.slice(1);
}

d.fusionName=firstPart+secondPart;
}

d.exists=d.exists&&d2.exists;
return new Species(fusedId,d.name,d);
}
...
data.abilities=[];
for(var _i3 in abilities)
{
var ability=abilities[_i3];
if(!ability)continue;
...
var _decodeFusionID2=decodeFusionID(id),head=_decodeFusionID2[0],body=_decodeFusionID2[1];
if(body){
id=head;
}
...
var spriteData={
spriteid:spriteid,
spriteDir:'sprites/fusion',
x:12,
y:4
};

if(!species.isFusion&&pokemon.shiny)spriteData.shiny=true;
...
spriteData.spriteDir='sprites/fusion';
return spriteData;
};_proto2.
...
var prefix='';
return'background-image:url('+prefix+data.spriteDir+shiny+'/'+data.spriteid+'.png);background-position:'+data.x+'px '+data.y+'px;background-repeat:no-repeat;background-size:88px;';
};_proto2.
...
this.pokeballs=[];
if(!window.BattleItems)window.BattleItems={};for(var _i7=0,_ref3=
Object.values(window.BattleItems);_i7<_ref3.length;_i7++){var data=_ref3[_i7];
...
if(this.pokeballs)return this.pokeballs;
this.pokeballs=[];
if(!window.BattleItems)window.BattleItems={};for(var _i9=0,_ref5=
Object.values(window.BattleItems);_i9<_ref5.length;_i9++){var data=_ref5[_i9];
...
function Species(id,name,data){this.effectType='Species';this.id=void 0;this.name=void 0;this.gen=void 0;this.exists=void 0;this.baseSpecies=void 0;this.forme=void 0;this.formeid=void 0;this.spriteid=void 0;this.baseForme=void 0;this.isFusion=void 0;this.fusionName=void 0;this.num=void 0;this.types=void 0;this.abilities=void 0;this.baseStats=void 0;this.bst=void 0;this.weightkg=void 0;this.heightm=void 0;this.gender=void 0;this.color=void 0;this.genderRatio=void 0;this.eggGroups=void 0;this.tags=void 0;this.otherFormes=void 0;this.cosmeticFormes=void 0;this.evos=void 0;this.prevo=void 0;this.evoType=void 0;this.evoLevel=void 0;this.evoMove=void 0;this.evoItem=void 0;this.evoCondition=void 0;this.requiredItems=void 0;this.tier=void 0;this.isTotem=void 0;this.isMega=void 0;this.cannotDynamax=void 0;this.canGigantamax=void 0;this.isPrimal=void 0;this.battleOnly=void 0;this.isNonstandard=void 0;this.unreleasedHidden=void 0;this.changesFrom=void 0;
if(!data||typeof data!=='object')data={};
if(data.name)name=data.name;
this.name=Dex.sanitizeName(name);
this.id=id;
...
var _decodeFusionID=decodeFusionID(toID(this.baseSpecies)),baseId=_decodeFusionID[0],secondaryId=_decodeFusionID[1];
...
this.isFusion=false;
this.fusionName=data.fusionName;
if(secondaryId)
{
this.isFusion=true;
}

if(data.spriteid)this.spriteid=data.spriteid;
...
this.abilities=data.abilities||["No Ability"];
